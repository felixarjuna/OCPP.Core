...
public partial class ChargingScheduleType
{
  ...
  public ICollection<ChargingSchedulePeriodType> ChargingSchedulePeriod { get; set; } = new System.Collections.ObjectModel.Collection<ChargingSchedulePeriodType>();
...
public partial class ConsumptionCostType
{
  ...
  public ICollection<CostType> Cost { get; set; } = new System.Collections.ObjectModel.Collection<CostType>();
}
...
public partial class SalesTariffEntryType
{
  ...
  [System.ComponentModel.DataAnnotations.MinLength(1)]
  [System.ComponentModel.DataAnnotations.MaxLength(3)]
  public ICollection<ConsumptionCostType> ConsumptionCost { get; set; }
}
...
public partial class SalesTariffType
{
  ...
  [System.ComponentModel.DataAnnotations.MinLength(1)]
  [System.ComponentModel.DataAnnotations.MaxLength(1024)]
  public ICollection<SalesTariffEntryType> SalesTariffEntry { get; set; } = new System.Collections.ObjectModel.Collection<SalesTariffEntryType>();
}
...
public partial class NotifyChargingLimitRequest
{
  ...
  [System.ComponentModel.DataAnnotations.MinLength(1)]
  public ICollection<ChargingScheduleType> ChargingSchedule { get; set; }
